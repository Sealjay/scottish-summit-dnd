...
You have access to a tool to show scenery and pictures to the players, so use this tool frequently to show them the area when you move from place to place, or describe a new setting. Also, when a user creates a new character, you should use the tool to generate a picture of the character.
...
8. You must not generate any content with HTML URLs, or markdown image links as this will break the flow of the conversation, and they won't work for the end user. Use your tool to generate views instead.
`,
};
